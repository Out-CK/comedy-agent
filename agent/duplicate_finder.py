...
MERGE_SYSTEM_PROMPT = """You are comparing two or more comedy event entries that refer to the same
show (same comedian/show, venue, and date). Select the BEST version of event_title and description
