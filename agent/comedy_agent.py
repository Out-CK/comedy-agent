"""
ComedyAgent — top-level orchestrator for the full Comedy Run pipeline.

Same pipeline as ConcertAgent but tuned for comedy show discovery.
Writes to the same event_entry_database with event_type='comedy'.
"""
...
class ComedyAgent:
    ...
    def run(self) -> None:
        ...
        # Step 4 — Find Additional Comedy Links
        ...
        logger.info(
            f"=== Comedy Run COMPLETE | entry_batch_id={entry_batch_id} | "
