"""
Eventbrite API v3 client — comedy events.

Docs: https://www.eventbrite.com/platform/api
Requires: EVENTBRITE_API_KEY env var

Eventbrite category IDs:
  110 = Comedy (most specific)
  105 = Performing & Visual Arts (broader fallback)
"""
...
COMEDY_CATEGORY_ID = "110"  # Eventbrite Comedy category
PAGE_SIZE = 50
...
class EventbriteClient:
    ...
    def fetch_nyc_comedy(self, days_ahead: int = 90) -> list[dict]:
        """Return upcoming NYC comedy events within the next `days_ahead` days."""
        ...
        logger.info(f"Eventbrite: fetched {len(all_events)} comedy events")
        return all_events
